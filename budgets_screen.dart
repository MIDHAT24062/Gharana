      ...
      body: budgets.isEmpty
          ...
          : ListView(
              ...
              children: [
                ...
                // ── Near-limit alert ──
                Builder(builder: (ctx) {
                  final near = budgets.where((b) => state.spentForBudget(b) / b.limit >= 0.8).toList();
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Text(
                          '${near.length} budget${near.length > 1 ? 's' : ''} near or over limit: ${near.map((b) => b.category).join(', ')}',
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setLocal) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (!isEdit) ...[
            ...
            const SizedBox(height: 8),
            Wrap(spacing: 8, runSpacing: 8, children: AppState.categories
